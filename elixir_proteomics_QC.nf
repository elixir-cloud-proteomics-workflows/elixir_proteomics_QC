...
/* 
 * Elixir Proteomics QC pipeline by Bioinformatics Core & Proteomics Core @ CRG
 *
 * @authors
...
log.info """elixir_proteomics_QC - N F  ~  version ${version}
========================================
┌─┐┬  ┬─┐ ┬┬┬─┐    ┌─┐┬─┐┌─┐┌┬┐┌─┐┌─┐┌┬┐┬┌─┐┌─┐    ╔═╗ ╔═╗
├┤ │  │┌┴┬┘│├┬┘    ├─┘├┬┘│ │ │ ├┤ │ ││││││  └─┐    ║═╬╗║  
└─┘┴─┘┴┴ └─┴┴└─────┴  ┴└─└─┘ ┴ └─┘└─┘┴ ┴┴└─┘└─┘────╚═╝╚╚═╝
...
// Output folder
out_folder      = file(params.out_folder)
